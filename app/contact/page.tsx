        ...
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-base leading-relaxed text-neutral-300 md:text-lg">
              Request submission access for export-focused refined product transactions via the Dubai
              execution desk. Progression is documentation-led and aligned to seller/refinery process
              discipline.
            </p>
            ...
            <div className="mt-7 rounded-2xl border border-neutral-800 bg-neutral-900/25 p-6">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm leading-relaxed text-neutral-300">
                  For preliminary discussions and process alignment only. This page does not constitute an
                  offer, allocation commitment, or binding agreement.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <aside className="space-y-6 lg:col-span-1">
            ...
            <div className="rounded-2xl border border-neutral-800 bg-neutral-900/25 p-7">
              <h2 className="text-lg font-semibold text-neutral-100">Dubai Execution Desk</h2>
              ...
              <div className="mt-6 space-y-5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-neutral-100">Office Location</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:info@simcolgroup.com"
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-neutral-100">Business Hours</h3>
            ...
            <div className="rounded-2xl border border-neutral-800 bg-neutral-900/25 p-7">
              <div className="flex items-start justify-between gap-3">
                <h3 className="text-sm font-semibold text-neutral-100">Minimum Buyer Inputs</h3>
            ...
            <div className="rounded-2xl border border-neutral-800 bg-neutral-900/25 p-7">
              <div className="flex items-start justify-between gap-3">
                <h3 className="text-sm font-semibold text-neutral-100">Submission Pack (KYB/KYC)</h3>
              ...
              <div className="mt-5 rounded-xl border border-neutral-800 bg-neutral-950/70 p-4">
                <p className="text-xs leading-relaxed text-neutral-400">
                  Where required by the seller/refinery, financial prerequisites may include PB/deposit/prepayment
                  or other instruments (e.g., LC/SBLC). Such requirements remain the buyer’s responsibility as a
                  condition precedent to commercial progression.
                </p>
              </div>
            </div>
          </aside>
          ...
          <section className="lg:col-span-2">
            <div className="rounded-2xl border border-neutral-800 bg-neutral-900/25 p-8 md:p-10">
              <h2 className="text-2xl font-semibold text-neutral-100">Submission Request</h2>
              <p className="mt-2 text-sm leading-relaxed text-neutral-300">
                Provide concise details. If you already have a documentation pack prepared, reference it in your message
                and we will confirm the appropriate submission pathway.
              </p>
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                ...
                <p className="text-center text-xs text-neutral-500">Fields marked * are required.</p>
              </form>

              {/* Bottom disclaimers */}
              <div className="mt-10 rounded-2xl border border-neutral-800 bg-neutral-950/50 p-6">
                <h3 className="text-sm font-semibold text-neutral-100">Important Notes</h3>
